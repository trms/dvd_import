// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// rdppm.c:	part of the mjpgTools Library																				 //
//			This file contains routines to read input images in PPM/PGM format.											 //
//																														 //
//			The extended 2-byte-per-sample raw PPM/PGM formats are supported. The PBMPLUS library is NOT required to	 //
//			compile this software (but it is highly useful as a set of PPM image manipulation programs).				 //
// --------------------------------------------------------------------------------------------------------------------- //
