// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// wrbmp.c:	part of the mjpgTools Library																				 //
//			This file contains routines to write output images in Microsoft "BMP" format (MS Windows 3.x and OS/2 1.x	 //
//			flavors).																									 //
//																														 //
//			Either 8-bit colormapped or 24-bit full-color format can be written. No compression is supported.			 //
// --------------------------------------------------------------------------------------------------------------------- //
