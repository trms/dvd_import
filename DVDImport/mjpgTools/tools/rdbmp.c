// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// rdbmp.c:	part of the mjpgTools Library																				 //
//			This file contains routines to read input images in Microsoft "BMP" format (MS Windows 3.x, OS/2 1.x, and	 //
//			OS/2 2.x flavors).																							 //
//																														 //
//			Currently, only 8-bit and 24-bit images are supported, not 1-bit or 4-bit (feeding such	low-depth images	 //
//			into JPEG would be silly anyway). Also, we don't support RLE-compressed files.								 //
// --------------------------------------------------------------------------------------------------------------------- //
