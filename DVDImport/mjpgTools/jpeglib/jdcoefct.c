// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jdcoefct.c:	part of the mjpgTools Library																			 //
//				This file contains the coefficient buffer controller for decompression. This controller is the top level //
//				of the JPEG decompressor proper. The coefficient buffer lies between entropy decoding and inverse-DCT	 //
//				steps. In buffered-image mode, this controller is the interface between input-oriented processing and	 //
//				output-oriented processing. Also, the input side (only) is used when reading a file for transcoding.	 //
// --------------------------------------------------------------------------------------------------------------------- //
