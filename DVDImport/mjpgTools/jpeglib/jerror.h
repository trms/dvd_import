// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jerror.h:	part of the mjpgTools Library																			 //
//				This file defines the error and message codes for the JPEG library. Edit this file to add new codes, or	 //
//				to translate the message strings to some other language. A set of error-reporting macros are defined too.//
//				Some applications using the JPEG library may wish to include this file to get the error codes and/or the //
//				macros.																									 //
// --------------------------------------------------------------------------------------------------------------------- //
