// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jmemsys.h:	part of the mjpgTools Library																			 //
//				This include file defines the interface between the system-independent and system-dependent portions of	 //
//				the JPEG memory manager. No other modules need include it. (The system-independent portion is jmemmgr.c; //
...
EXTERN(INT32) jpeg_mem_available JPP((j_common_ptr cinfo,
				     INT32 min_bytes_needed,
				     INT32 max_bytes_needed,
				     INT32 already_allocated));
...
typedef UINT16 XMSH;	/* type of extended-memory handles */
typedef UINT16 EMSH;	/* type of expanded-memory handles */

typedef union {
  INT16 file_handle;		/* DOS file handle if it's a temp file */
...
typedef struct backing_store_struct {
  ...
  JMETHOD(void, read_backing_store, (j_common_ptr cinfo,
				     ...
				     INT32 file_offset, INT32 byte_count));
  ...
  INT16 temp_file;		/* file reference number to temp file */
...
EXTERN(INT32) jpeg_mem_init JPP((j_common_ptr cinfo));
