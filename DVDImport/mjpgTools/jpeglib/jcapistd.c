// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jcapistd.c:	part of the mjpgTools Library																			 //
//				This file contains application interface code for the compression half of the JPEG library. These are	 //
//				the "standard" API routines that are used in the normal full-compression case. They are not used by a	 //
//				transcoding-only application. Note that if an application links in jpeg_start_compress, it will end up	 //
//				linking in the entire compressor. We thus must separate this file from jcapimin.c to avoid linking the	 //
