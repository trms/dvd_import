// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jdpostct.c:	part of the mjpgTools Library																			 //
//				This file contains the decompression postprocessing controller. This controller manages the upsampling,	 //
//				color conversion, and color quantization/reduction steps; specifically, it controls the buffering		 //
//				between upsample/color conversion and color quantization/reduction.										 //
//				If no color quantization/reduction is required, then this module has no work to do, and it just hands	 //
//				off to the upsample/color conversion code. An integrated upsample/convert/quantize process would replace //
