// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jcprepct.c:	part of the mjpgTools Library																			 //
//				This file contains the compression preprocessing controller. This controller manages the color			 //
//				conversion, downsampling, and edge expansion steps.														 //
//				Most of the complexity here is associated with buffering input rows as required by the downsampler.		 //
//				See the comments at the head of jcsample.c for the downsampler's needs.									 //
// --------------------------------------------------------------------------------------------------------------------- //
