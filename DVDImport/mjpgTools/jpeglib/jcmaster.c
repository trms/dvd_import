// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jcmaster.c:	part of the mjpgTools Library																			 //
//				This file contains master control logic for the JPEG compressor. These routines are concerned with		 //
//				parameter validation, initial setup, and inter-pass control (determining the number of passes and the	 //
//				work to be done in each pass).																			 //
// --------------------------------------------------------------------------------------------------------------------- //
