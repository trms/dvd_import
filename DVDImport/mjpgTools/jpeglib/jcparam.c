// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jcparam.c:	part of the mjpgTools Library																			 //
//				This file contains optional default-setting code for the JPEG compressor. Applications do not have to use//
//				this file, but those that don't use it must know a lot more about the innards of the JPEG code.			 //
// --------------------------------------------------------------------------------------------------------------------- //
...
GLOBAL(void)
jpeg_add_quant_table (j_compress_ptr cinfo, INT32 which_tbl,
		      const UINT32* basic_table,
		      INT32 scale_factor, boolean force_baseline)
...
GLOBAL(void)
jpeg_set_linear_quality (j_compress_ptr cinfo, INT32 scale_factor,
...
GLOBAL(INT32)
jpeg_quality_scaling (INT32 quality)
...
GLOBAL(void)
jpeg_set_quality (j_compress_ptr cinfo, INT32 quality, boolean force_baseline)
/* Set or change the 'quality' (quantization) setting, using default tables.
...
fill_a_scan (jpeg_scan_info * scanptr, INT32 ci,
	     INT32 Ss, INT32 Se, INT32 Ah, INT32 Al)
...
LOCAL(jpeg_scan_info *)
fill_scans (jpeg_scan_info * scanptr, INT32 ncomps,
	    INT32 Ss, INT32 Se, INT32 Ah, INT32 Al)
...
LOCAL(jpeg_scan_info *)
fill_dc_scans (jpeg_scan_info * scanptr, INT32 ncomps, INT32 Ah, INT32 Al)
...
{
  INT32 ncomps = cinfo->num_components;
  INT32 nscans;
