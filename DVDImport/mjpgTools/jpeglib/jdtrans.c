// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jdtrans.c:	part of the mjpgTools Library																			 //
//				This file contains library routines for transcoding decompression, that is, reading raw DCT coefficient	 //
//				arrays from an input JPEG file. The routines in jdapimin.c will also be needed by a transcoder.			 //
// --------------------------------------------------------------------------------------------------------------------- //
