// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jcmainct.c:	part of the mjpgTools Library																			 //
//				This file contains the main buffer controller for compression. The main buffer lies between the			 //
//				pre-processor and the JPEG compressor proper; it holds downsampled data in the JPEG colorspace.			 //
// --------------------------------------------------------------------------------------------------------------------- //
