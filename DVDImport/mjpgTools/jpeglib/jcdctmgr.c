// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jcdctmgr.c:	part of the mjpgTools Library																			 //
//				This file contains the forward-DCT management logic. This code selects a particular DCT implementation	 //
//				to be used, and it performs related housekeeping chores including coefficient quantization.				 //
// --------------------------------------------------------------------------------------------------------------------- //
