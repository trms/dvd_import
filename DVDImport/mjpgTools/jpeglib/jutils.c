// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jutils.c:	part of the mjpgTools Library																			 //
//				This file contains tables and miscellaneous utility routines needed for both compression and decom-		 //
//				pression. Note we prefix all global names with "j" to minimize conflicts with a surrounding application. //
// --------------------------------------------------------------------------------------------------------------------- //
...
const INT32 jpeg_zigzag_order[DCTSIZE2] = {
   0,  1,  5,  6, 14, 15, 27, 28,
...
const INT32 jpeg_natural_order[DCTSIZE2+16] = {
  0,  1,  8, 16,  9,  2,  3, 10,
...
/* Copy a row of coefficient blocks from one place to another. */
{
  ...
  for (count = (INT32) num_blocks * DCTSIZE2; count > 0; count--) {
    *outptr++ = *inptr++;
  }
#endif
}
...
#else
  register UINT8 FAR * ptr = (UINT8 FAR*) target;
