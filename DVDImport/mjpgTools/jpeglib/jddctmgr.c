// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jddctmgr.c:	part of the mjpgTools Library																			 //
//				This file contains the inverse-DCT management logic. This code selects a particular IDCT implementation	 //
//				to be used, and it performs related housekeeping chores. No code in this file is executed per IDCT step, //
//				only during output pass setup.																			 //
//				Note that the IDCT routines are responsible for performing coefficient dequantization as well as the	 //
//				IDCT proper. This module sets up the dequantization multiplier table needed by the IDCT routine.		 //
// --------------------------------------------------------------------------------------------------------------------- //
