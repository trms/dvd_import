// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jdcolor.c:	part of the mjpgTools Library																			 //
...
build_ycc_rgb_table (j_decompress_ptr cinfo)
{
  ...
  for (i = 0, x = -CENTERJSAMPLE; i <= MAXJSAMPLE; i++, x++) {
    ...
    cconvert->Cr_r_tab[i] = (INT32)
      RIGHT_SHIFT(FIX(1.40200) * x + ONE_HALF, SCALEBITS);
    /* Cb=>B value is nearest int to 1.77200 * x */
    cconvert->Cb_b_tab[i] = (INT32) 
 ...
 */
		...
		static const UINT64 bpte0 = 0x0080008000800080; // 128
		static const UINT64 bpte1 = 0x7168e9f97168e9f9; // for cb (Cb/b, Cb/g, Cb/b, Cb/g)
		static const UINT64 bpte2 = 0xd21a59bad21a59ba; // for cr (Cr/g, Cr/r, Cr/g, Cr/r)
	#else
		static const UINT64 te0 = 0x0200020002000200; // -128 << 2
		static const UINT64 te1 = 0xe9fa7168e9fa7168; // for cb
		static const UINT64 te2 = 0x59bad24d59bad24d; // for cr
	#endif
	//static const UINT64 te2 = 0x59ba524b59ba524b; // for cr
	      ...
	      JSAMPARRAY output_buf, INT32 num_rows)
{
  ...
  register INT32 num_components = cinfo->num_components;
  JDIMENSION num_cols = cinfo->output_width;
  INT32 ci;
...
grayscale_convert (j_decompress_ptr cinfo,
		   ...
		   JSAMPARRAY output_buf, INT32 num_rows)
{
  jcopy_sample_rows(input_buf[0], (INT32) input_row, output_buf, 0,
...
jinit_color_deconverter (j_decompress_ptr cinfo)
{
  ...
  case JCS_RGB: 
      ...
      else
	{
	  ...
	  //build_ycc_rgb_table(cinfo);
#endif
	build_ycc_rgb_table(cinfo); // it seems the JPEG Group forgot to enter this too when no mmx is available - it must always been done !!
