// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jidctint.c:	part of the mjpgTools Library																			 //
//				This file contains a slow-but-accurate integer implementation of the inverse DCT (Discrete Cosine		 //
//				Transform). In the IJG code, this routine must also perform dequantization of the input coefficients.	 //
// --------------------------------------------------------------------------------------------------------------------- //
 ...
 */
#define __int64 unsigned __int64
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  domidct8x8llmW(coef_block, compptr->dct_table, workspace, output_buf, output_col);
