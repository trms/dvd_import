// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// motion.c: motion estimation, part of the mjpgTools Library															 //
// --------------------------------------------------------------------------------------------------------------------- //
...
static __inline int bidir_pred_var( const mb_motion_s *motion_f, 
...
static __inline int chrom_var_sum( subsampled_mb_s *ssblk, int h, int lx )
{
...
static __inline int bidir_pred_sad( const mb_motion_s *motion_f, 
									  const mb_motion_s *motion_b,
									  uint8_t *mb,  
									  int lx, int h)
{
