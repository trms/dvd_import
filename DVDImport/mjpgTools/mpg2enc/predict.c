// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// predict.c: motion compensated prediction, double precision, part of the mjpgTools Library							 //
// --------------------------------------------------------------------------------------------------------------------- //
	...
	if ((mbi->mb_type & MB_FORWARD) || (picture->pict_type==P_TYPE))
	{
		...
		if (picture->pict_struct==FRAME_PICTURE)
		{
			...
			else
			{
				...
				errorExit_msg("Internal: invalid motion_type");
			}
		}
