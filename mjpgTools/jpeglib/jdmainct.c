// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jdmainct.c:	part of the mjpgTools Library																			 //
//				This file contains the main buffer controller for decompression. The main buffer lies between the JPEG	 //
//				decompressor proper and the post-processor; it holds downsampled data in the JPEG colorspace.			 //
//				Note that this code is bypassed in raw-data mode, since the application supplies the equivalent of the	 //
//				main buffer in that case.																				 //
// --------------------------------------------------------------------------------------------------------------------- //
