// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jdinput.c:	part of the mjpgTools Library																			 //
//				This file contains input control logic for the JPEG decompressor. These routines are concerned with		 //
//				controlling the decompressor's input processing (marker reading and coefficient decoding). The actual	 //
//				input reading is done in jdmarker.c, jdhuff.c, and jdphuff.c.											 //
// --------------------------------------------------------------------------------------------------------------------- //
