// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// jdapimin.c:	part of the mjpgTools Library																			 //
//				This file contains application interface code for the decompression half of the JPEG library.			 //
//				These are the "minimum" API routines that may be needed in either the normal full-decompression case or	 //
//				the transcoding-only case.																				 //
//				Most of the routines intended to be called directly by an application are in this file or in jdapistd.c. //
//				But also see jcomapi.c for routines shared by compression and decompression, and jdtrans.c for the		 //
//				transcoding case.																						 //
// --------------------------------------------------------------------------------------------------------------------- //
...
GLOBAL(void)
jpeg_CreateDecompress (j_decompress_ptr cinfo, INT32 version, size_t structsize)
{
  INT32 i;

#if defined(HAVE_MMX_INTEL_MNEMONICS) || defined(HAVE_MMX_ATT_MNEMONICS)
  static INT32 cpuidDetected = 0;
  ...
  if (structsize != SIZEOF(struct jpeg_decompress_struct))
    ERREXIT2(cinfo, JERR_BAD_STRUCT_SIZE, 
	     (INT32) SIZEOF(struct jpeg_decompress_struct), (INT32) structsize);
...
default_decompress_parms (j_decompress_ptr cinfo)
{
  ...
  case 3:
	...
	break;
      ...
      INT32 cid0 = cinfo->comp_info[0].component_id;
      INT32 cid1 = cinfo->comp_info[1].component_id;
      INT32 cid2 = cinfo->comp_info[2].component_id;
