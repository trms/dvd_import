// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// rdgif.c:	part of the mjpgTools Library																				 //
//			This file contains routines to read input images in GIF format.												 //
//																														 //
//			These routines may need modification for non-Unix environments or specialized applications. As they stand,	 //
//			they assume input from an ordinary stdio stream.  They further assume that reading begins at the start of	 //
//			the file; input_init may need work if the user interface has already read some data (e.g., to determine that //
 ...
 * WE NEED GIF SUPPORT - so we'll using the previous version of 'rdgif.c'
 */
/*
...
METHODDEF(JDIMENSION) get_pixel_rows			JPP((j_compress_ptr cinfo, cjpeg_source_ptr sinfo));
METHODDEF(JDIMENSION) load_interlaced_image	JPP((j_compress_ptr cinfo, cjpeg_source_ptr sinfo));
METHODDEF(JDIMENSION) get_interlaced_row		JPP((j_compress_ptr cinfo, cjpeg_source_ptr sinfo));
