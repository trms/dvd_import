// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// yuv4mpeg.h:	part of the mjpgTools Library																			 //
...
// indicate the compile we'll already have declared 'y4m_ratio_t'
...
typedef struct _y4m_stream_info {
  ...
  INT32				width;
  INT32				height;
  INT32				interlace;		/* see Y4M_ILACE_* definitions below   */
  ...
  INT32				framelength;	/* bytes of data per frame (not including header) */
  /* mystical X tags */
 ...
 *  '*_info' functions																									*
 *																														*
 * o Before using a *_info structure (but after the structure/memory has been allocated), you must initialize it		*
 *   via y4m_init_*_info().																								*
 * o After using a *_info structure (but before the structure is released), call y4m_fini_*_info() to free internal		*
 *   memory.																											*
 * o Use the 'set' and 'get' accessors to modify or access the fields in the structures; don't touch the structure		*
 *   directly.  (Ok, so there is no really convenient C syntax to prevent you from doing this, but we are all			*
 *   responsible programmers here, so just don't do it!)																*
 *																														*
 ************************************************************************************************************************/
