// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// //
// lav_common.c:	part of the mjpgTools Library																		 //
...
static UINT8 jpeg_data[MAX_JPEG_LEN];
...
INT32 pitches[3];
#endif
UINT8 *dv_frame[3] = {NULL,NULL,NULL};
...
static UINT8 *bufalloc(size_t size)
{
   ...
   adjust = BUFFER_ALIGN - ((UINT32) buf) % BUFFER_ALIGN;
   if (adjust == BUFFER_ALIGN)
      adjust = 0;
   return (UINT8 *) (buf + adjust);
}



void init(LavParam *param, UINT8 *buffer[])
{
...
INT32 readframe(INT32 numframe, 
	      UINT8 *frame[],
	      LavParam *param,
	      EditList el)
{
  INT32 len, i, res, data_format;
  UINT8 *frame_tmp;
...
void writeoutYUV4MPEGheader(INT32 out_fd,
			    LavParam *param,
			    EditList el,
